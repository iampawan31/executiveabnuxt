<template>
  <section class="bg-white text-black py-12 px-5 2xl:px-0">
    <div class="container mx-auto xl:px-32">
      <div class="mb-6">
        <h1 class="text-2xl xl:text-3xl font-semibold">Disclaimer</h1>
        <p class="text-xs text-gray-400">Last updated: June 05, 2021</p>
      </div>
      <h1 class="text-2xl mb-4">Interpretation and Definitions</h1>
      <div class="mb-4">
        <h2 class="text-xl mb-2">Interpretation</h2>
        <p>
      ...
      <div class="mb-4">
        <h2 class="text-xl mb-2">Definitions</h2>
        <p>For the purposes of this Disclaimer:</p>
        <ul class="list-disc list-inside">
          <li>
            <strong>Company</strong> (referred to as either &quot;the
            Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in
            this Disclaimer) refers to Executive Auto Broker, Inc., 8500 Redwood
            Creek Ln.
          </li>
          ...
          <li>
            <strong>Website</strong> refers to ExecutiveAB, accessible from
            <a
              href="www.executiveab.com"
              rel="external nofollow noopener"
              target="_blank"
              >www.executiveab.com</a
            >
          </li>
        </ul>
      </div>
      <div class="mb-4">
        <h1 class="text-xl mb-2">Disclaimer</h1>
        <p>
      ...
      <div class="mb-4">
        <h1 class="text-xl mb-2">External Links Disclaimer</h1>
        <p>
      ...
      <div class="mb-4">
        <h1 class="text-xl mb-2">Errors and Omissions Disclaimer</h1>
        <p>
      ...
      <div class="mb-4">
        <h1 class="text-xl mb-2">Fair Use Disclaimer</h1>
        <p>
      ...
      <div class="mb-4">
        <h1 class="text-xl mb-2">Views Expressed Disclaimer</h1>
        <p>
      ...
      <div class="mb-4">
        <h1 class="text-xl mb-2">No Responsibility Disclaimer</h1>
        <p>
      ...
      <div class="mb-4">
        <h1 class="text-xl mb-2">Contact Us</h1>
        <p class="mb-1">
        ...
        <ul class="list-dics list-inside">
          <li>
            By email:
            <a href="mailto:info@executiveab.com">info@executiveab.com</a>
          </li>
          <li>By phone number: 8772970252</li>
        </ul>
      </div>
      <hr class="my-5" />
      <div class="mb-6">
        <h1 class="text-2xl xl:text-3xl font-semibold">Privacy Policy</h1>
        <p class="text-xs text-gray-400">Last updated: June 05, 2021</p>
      </div>
      <div class="mb-4">
        <p>
      ...
      <div class="mb-4">
        ...
        <ul class="list-disc list-inside">
          ...
          <li>
            <strong>Company</strong> (referred to as either &quot;the
            Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in
            this Agreement) refers to Executive Auto Broker, Inc, 8500 Redwood
            Creek Ln.
          </li>
          <li>
      ...
      <h1 class="text-2xl mb-4">Collecting and Using Your Personal Data</h1>
      <div class="mb-4">
        <h2 class="text-xl mb-2">Types of Data Collected</h2>
        <h3 class="text-lg mb-1">Personal Data</h3>
        <p>
      ...
      <div class="mb-4">
        <h3 class="text-lg mb-1">Usage Data</h3>
      ...
      <div class="mb-4">
        <h3 class="text-lg mb-1">Tracking Technologies and Cookies</h3>
        <p>
      ...
      <div class="mb-4">
        <h2 class="text-xl mb-2">Use of Your Personal Data</h2>
      ...
      <div class="mb-4">
        <h2 class="text-xl mb-2">Retention of Your Personal Data</h2>
        <p>
      ...
      <div class="mb-4">
        <h2 class="text-xl mb-2">Transfer of Your Personal Data</h2>
        <p>
      ...
      <div class="mb-4">
        <h2 class="text-xl mb-2">Disclosure of Your Personal Data</h2>
        <h3 class="text-lg mb-1">Business Transactions</h3>
        <p>
      ...
      <div class="mb-4">
        <h3 class="text-lg mb-1">Law enforcement</h3>
        <p>
      ...
      <div class="mb-4">
        <h3 class="text-lg mb-1">Other legal requirements</h3>
        <p>
      ...
      <div class="mb-4">
        <h2 class="text-xl mb-2">Security of Your Personal Data</h2>
        <p>
      ...
      <div class="mb-4">
        <h1 class="text-xl mb-2">Children's Privacy</h1>
        <p>
      ...
      <div class="mb-4">
        <h1 class="text-xl mb-2">Links to Other Websites</h1>
        <p>
      ...
      <div class="mb-4">
        <h1 class="text-xl mb-2">Changes to this Privacy Policy</h1>
        <p>
      ...
      <div class="mb-6">
        <h1 class="text-2xl xl:text-3xl font-semibold">Cookies Policy</h1>
        <p class="text-xs text-gray-400">Last updated: June 05, 2021</p>
      </div>
      <div class="mb-4">
        <p>
      ...
      <div class="mb-4">
        ...
        <ul class="list-disc list-inside">
          <li>
            <strong>Company</strong> (referred to as either &quot;the
            Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in
            this Cookies Policy) refers to Executive auto Broker, Inc, 8500
            Redwood Creek Ln.
          </li>
          <li>
      ...
      <div class="mb-4">
        <h1 class="text-xl mb-2">The use of the Cookies</h1>
      ...
      <div class="mb-4">
        <h2 class="text-xl mb-2">Your Choices Regarding Cookies</h2>
        <p>
      ...
      <div class="mb-4">
        <h2 class="text-xl mb-2">More Information about Cookies</h2>
        <p>
      ...
      <div class="mb-4">
        ...
        <ul class="list-dics list-inside">
          <li>
            By email:
            <a href="mailto:info@executiveab.com" class="text-brand underline"
              >info@executiveab.com</a
            >
          </li>
          <li>By phone number: 8772970252</li>
        </ul>
